function Y = TensorRandTruncSVD(X,tau,r)
...
% Using truncated svd
[Ut1,~,~] = ComputeRandomizedTruncatedSVDUnfoldedxTensor(X,tau,1,r); % mode-1
[Ut2,~,~] = ComputeRandomizedTruncatedSVDUnfoldedxTensor(X,tau,2,r); % mode-2
[Ut3,~,~] = ComputeRandomizedTruncatedSVDUnfoldedxTensor(X,tau,3,r); % mode-3
